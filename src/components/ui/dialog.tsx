...
// The column is minmax(0,1fr) rather than the implicit auto track: a grid
// item's min-width defaults to its min-content width, so one unbreakable
// child — a long URL, a code block — stretches the track past the dialog and
// everything else in it spills out of the card with it. On a phone that shows
// up as buttons running off the right edge of the screen.
