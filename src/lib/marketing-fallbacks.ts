...
export const FALLBACK_SLIDES: FallbackSlide[] = [
  {
    ...
    title: "A royal invitation, ready in minutes",
    href: "/create",
  ...
  {
    id: "fallback-beach",
    eyebrow: "Website · PDF · Video",
    title: "One invitation, three ways to share it",
    href: "/create",
    cta: "Get started",
    primary: "#2e6a7a",
    accent: "#8fd0d8",
  ...
  {
    id: "fallback-floral",
    eyebrow: "Comment FREE on Instagram",
    title: "Your invite link, sent straight to your DMs",
    href: "/create",
